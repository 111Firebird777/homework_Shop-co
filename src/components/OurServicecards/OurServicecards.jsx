          ...
          <div className={s.wrapper}>
            <nav className={s.nav}>
              <div className={s.text}>
                ...
                <h1 classname={s.h1__our-service}>Our Service</h1>
              </div>
            ...
            <div className={s.box}>
              <div className={s.vr_block_1}>
                <div className={s.vr}>
                  <img src="/OurService_card-1.svg" alt="" />

                  <div>
                    <h1 classname={s.h1__our-service}>VR Development</h1>
                    <p>
                ...
                <div className={s.vr}>
                  <img src="/OurService_card-2.svg" alt="" />

                  <div>
                    <h1 classname={s.h1__our-service}>VR Games</h1>
                    <p>
              ...
              <div className={s.vr_block_2}>
                <div className={s.vr}>
                  <img src="/OurService_card-3.svg" alt="" />

                  <div>
                    <h1 classname={s.h1__our-service}>VR Design</h1>
                    <p>
                ...
                <div className={s.vr}>
                  <img src="/OurService_card-4.svg" alt="" />

                  <div>
                    <h1 classname={s.h1__our-service}>VR Events</h1>
                    <p>
                      We offer a wide selection of VR games that are suitable
                      for players of all ages and skill levels.
                    </p>
              ...
              <div className={s.vr_block_3}>
                <div className={s.vr}>
                  <img src="/OurService_card-5.svg" alt="" />

                  <div>
                    <h1 classname={s.h1__our-service}>VR Consulting</h1>
                    <p>
                ...
                <div className={s.vr}>
                  <img src="/OurService_card-6.svg" alt="" />

                  <div>
                    <h1 classname={s.h1__our-service}>VR Entertainment</h1>
                    <p>
                      reate a VR escape room, or offer VR experiences at a theme
